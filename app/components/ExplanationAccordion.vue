...
<template>
  <details class="group border border-b-gray-300 rounded-lg overflow-hidden bg-gray-50">
    <summary
    ...
    <MDC :value="props.explaination" tag="div" class="mdc rounded-lg overflow-hidden p-4" />
  </details>
</template>
